...
export default function PermitManagementPage() {
  ...
  return (
    <PermissionGuard permission="permit.view" showPageDenied>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-[18px] text-[#777777] mt-1 mb-4">
              Monitor vehicle state permits, validity periods, fees and compliance.
            </p>
            ...
            <div className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-blue-50 border border-blue-100 rounded-md text-[13px] font-medium text-blue-700">
              ...
              Permit information is managed from Motor Vehicle Entry.
            </div>
          </div>
          ...
          {isError ? (
            <div className="bg-white border border-[#E5E5E5] rounded-[16px] p-12 shadow-sm flex flex-col items-center text-center">
              ...
              <p className="text-[15px] text-[#777777] max-w-md mb-6">
                We couldn't retrieve permit records from Motor Vehicle data. Please check your connection and try again.
              </p>
              <button
                onClick={() => refetch()}
